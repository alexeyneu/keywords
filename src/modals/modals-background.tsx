...
export const ModalsBackground:React.FC<Props> = ({children}) => {

    const [isActiveModal, setIsActiveModal] = useState(true);

    const bodyEl: HTMLBodyElement | any = document.querySelector('body');
    ...
    return(
        ...
        <ModalBackground>
            <ModalContent>
                <CloseButtonModal onClick={() => setIsActiveModal(!isActiveModal)}>
